  ...
  <div id="app" v-bind:class="[state]">
    ...
    <header class="header">
      ...
      <div class="box">
        ...
        <h3>请一生保持善良，热情</h3>
        <p class="socials">
          <a href="https://github.com/zaoansijia" target="_blank" class='icon github'></a>
          <a href="https://github.com/zaoansijia" target="_blank" class='icon sina'></a>
          <a href="https://github.com/zaoansijia"  target="_blank" class='icon twitter'></a>
        </p>
      </div>
...
<script>
// import './utils/canvas-easePack';
// import './utils/canvas-tweenLite';
...
export default {
  ...
  computed: {},
  mounted () {
    // CanvasPainter.initRenderCanvas();
  },
  methods: {
    rollDown: function () {
 ...
 * {
 ...
 .header {
   ...
   width: 100%;
   height: 100%;
   background: url('./assets/theme4.jpg') no-repeat center;
